...
//     if (user?.role !== "ADMIN") {
//       alert("Permission denied. Only Administrators can delete workspaces.");
//       return;
//     }

//     if (workspaces.length <= 1) {
//       alert(
//         "You cannot delete your only workspace. Please create another one first."
//       );
//       return;
//     }
...
//     if (
//       window.confirm(
//         `Are you sure you want to permanently delete "${ws.name}"?\n\nAll tasks and logs in this space will be lost forever.`
//       )
//     ) {
//       deleteWorkspace(ws.id);
//       setIsWsOpen(false);
//       setSelectedWsInfo(null);
//     }
//   };
...
//           className="flex items-center gap-3 p-2 mb-4 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition"
//         >
//           {/* <img
//             src={user?.avatar}
//             alt={user?.name}
...
//               src={user?.avatar}
//               alt={user?.name}
//               className="w-10 h-10 rounded-full border-2 border-indigo-100 shadow-sm hover:opacity-80 transition"
